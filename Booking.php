...
if (isset($_POST['edit_order_name'], $_POST['edit_booking_id'])) {
    ...
    if ($edit_booking_id && $new_order_name) {
        ...
        $booking = getBookingID($edit_booking_id);
        if ($booking) {
            // Gunakan data lama untuk field lain
            ...
            // Update dengan fungsi updateBookings
            updateBookings($edit_booking_id, $new_order_name, $field_id, $booking_date, $start_time, $end_time, $booking_price, $status);
        }
    }
}
